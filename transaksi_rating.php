                        ...
                        while($d=mysqli_fetch_array($transaksi)){
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <i id="1" ke="<?php echo $d['kamar_id']; ?>" class="fa fa-star" style="color: orange"></i>
                              <i id="2" ke="<?php echo $d['kamar_id']; ?>" class="fa <?php if(rating($i['invoice_id'], $d['kamar_id']) >= 2){ echo "fa-star"; }else{ echo "fa-star-o"; } ?>" style="color: orange"></i>
                              <i id="3" ke="<?php echo $d['kamar_id']; ?>" class="fa <?php if(rating($i['invoice_id'], $d['kamar_id']) >= 3){ echo "fa-star"; }else{ echo "fa-star-o"; } ?>" style="color: orange"></i>
                              <i id="4" ke="<?php echo $d['kamar_id']; ?>" class="fa <?php if(rating($i['invoice_id'], $d['kamar_id']) >= 4){ echo "fa-star"; }else{ echo "fa-star-o"; } ?>" style="color: orange"></i>
                              <i id="5" ke="<?php echo $d['kamar_id']; ?>" class="fa <?php if(rating($i['invoice_id'], $d['kamar_id']) >= 5){ echo "fa-star"; }else{ echo "fa-star-o"; } ?>" style="color: orange"></i>

                            </td>
                            <td>
                              "<?php echo review($i['invoice_id'], $d['kamar_id']) ?>".
                            </td>
                          </tr>
                          <?php 
                        }
